System.register(['@angular/core', '../../directives/mdl.directive'], function(exports_1, context_1) {
    ...
    var MdlLayoutComponent, MdlHeaderComponent, MdlDrawerComponent;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            ...
            exports_1("MdlLayoutComponent", MdlLayoutComponent);
            MdlHeaderComponent = (function () {
            ...
            exports_1("MdlHeaderComponent", MdlHeaderComponent);
            MdlDrawerComponent = (function () {
            ...
            exports_1("MdlDrawerComponent", MdlDrawerComponent);
        }
    }
});
